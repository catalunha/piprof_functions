...
export function QuestaoOnUpdate(docSnapShot: any) {
  ...
  if (docSnapShotBeforeData.inicio != docSnapShotAfterData.inicio) {
    ...
    //Tarefa
    DatabaseReferences.updateQueryDocumentNoCampoXComValorX('Tarefa', 'questao.id', docSnapShotId, { 'inicio': docSnapShotAfterData.inicio })
  } else {
  ...
  if (docSnapShotBeforeData.fim != docSnapShotAfterData.fim) {
    ...
    //Tarefa
    DatabaseReferences.updateQueryDocumentNoCampoXComValorX('Tarefa', 'questao.id', docSnapShotId, { 'fim': docSnapShotAfterData.fim })
  } else {
  ...
  if (docSnapShotBeforeData.nota != docSnapShotAfterData.nota) {
    ...
    //Tarefa
    DatabaseReferences.updateQueryDocumentNoCampoXComValorX('Tarefa', 'questao.id', docSnapShotId, { 'questaoNota': docSnapShotAfterData.nota })
  } else {
...
export function QuestaoOnDelete(docSnapShot: any) {
  ...
  // Tarefa
  DatabaseReferences.onDeleteQueryDocument('Tarefa', 'questao.id', docSnapShotId)
  return 0;
}
